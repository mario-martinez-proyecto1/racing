...
Observaciones: los cilos del método draw no son constantes, lo que provoca que la velocidad varía
 ...
 es una aproximación, lo que permite que la velocidad media de todo el recorrido sea similar a la
...
/*
 Método:           keyPressed
 Descripción:      Método que permite utilizar las teclas direccionales, y las letras 'a', 'A' para acelerar
                   y 'd', 'D' para desacelerar
 **/
void keyPressed() {
  if (keyCode == RIGHT) {
    game.giroDerecha();
